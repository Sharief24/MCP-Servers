...
from analytics_mcp.tools.client import create_data_api_alpha_client_with_token
...
async def run_funnel_report(
    ...
    funnel_breakdown: Optional[Dict[str, Any]] = None,
    ...
    def _sync_call():
        return create_data_api_alpha_client_with_token(access_token).run_funnel_report(request)
