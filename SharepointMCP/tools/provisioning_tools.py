...
from tools._tool_helpers import _build_context
...
def register_provisioning_tools(mcp: FastMCP):
    ...
    async def create_sharepoint_site(
        access_token: str, display_name: str, alias: str, description: str = ""
    ) -> str:
    ...
    async def create_intelligent_list(
        access_token: str, site_id: str, purpose: str, display_name: str
    ) -> str:
    ...
    async def create_advanced_document_library(
        access_token: str, site_id: str, display_name: str, doc_type: str = "general"
    ) -> str:
